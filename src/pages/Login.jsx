...
// import { encodeRSA, decodeRSA } from '../constants/RSA';
// import { handleDecodeElgamal } from '../constants/encryption/ELGAMAL';
...
const Login = () => {
  ...
  const handleSubmitEmailAndPassword = async (e) => {
    ...
    // console.log("Password nhap vao: " + password);
    // const {secretNumber, coupleKeys, encode} = encodeRSA(password)
    // console.log(secretNumber);
    // console.log(coupleKeys);
    // console.log("After encode: " + encode);
    // const plainText = decodeRSA(encode, coupleKeys.privateKey, secretNumber.p * secretNumber.q)
    // console.log("After decode: " + plainText);
