...
import { decodeAFFINE } from '../../../constants/encryption/AFFINE';
        ...
        >
          ...
          >
            ...
            {type == 'message' && chatContent != '' ? (
              checkSpecialChar(chatContent) || checkValidInput(chatContent) ? (
                <p
                  style={
                    senderId == currentUser.uid
                      ? {
                ...
                >
                  ...
                  {checkValidInput(chatContent)
                    ? decodeAFFINE(chatContent)
                    : chatContent}
                </p>
              ) : (
                <p className="text-3xl">{chatContent}</p>
              )
